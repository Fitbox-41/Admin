...
import { Moon, Sun, User, Lock, LogOut, Trash2, Truck } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="glass p-6 rounded-xl max-w-2xl">
        ...
        {/* Store Settings */}
        <h3 className="font-bold mt-8 mb-4 text-text-dark text-lg border-b border-border pb-2">Store Settings</h3>
